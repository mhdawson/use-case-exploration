...
def main():
    ...
    try:
        ...
        for j in range(1):  # Reduced for testing
            print("")
            print(f"Iteration {j} ------------------------------------------------------------")
            ...
            iteration_questions = questions.copy()
            iteration_questions[2] = str(random.randint(1, 5))  # Randomize laptop choice
            
            try:
                for i, question in enumerate(iteration_questions):
